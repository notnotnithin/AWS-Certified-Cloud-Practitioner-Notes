...
- The first way is to use the billing dashboard, which will show you all the costs initiated for the month, the forecast, and the month-to-date, and the total forecasted cost for current month
